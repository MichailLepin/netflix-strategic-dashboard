...
- [ ] **Phase 1: Data Foundation** - Load, clean, type-cast, join, and validate all 6 CSV tables; confirm memory footprint and GitHub file size safety
- [ ] **Phase 2: Dashboard Skeleton, Filters, and KPIs** - Build the app shell with Netflix branding, sidebar filters, and all 4 KPI scorecard tiles wired to live data
...
| 2. Dashboard Skeleton, Filters, and KPIs | 0/2 | Not started | - |
